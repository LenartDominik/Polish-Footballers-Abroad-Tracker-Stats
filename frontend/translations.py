...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "compare_position_info": "You can compare goalkeepers with goalkeepers or field players with field players only.",
        ...
        "live_goal": "Goal",
        "live_assist": "Assist",
        "live_refreshed_ago": "refreshed {time} ago",
        "live_refreshed_just": "just refreshed",
        "live_status_no_match": "No live matches",
        "live_status_next_in": "Next match in {time}",
        "live_status_finished": "Match finished",
    ...
    "pl": {
        ...
        "live_goal": "Gol",
        "live_assist": "Asysta",
        "live_refreshed_ago": "odświeżono {time} temu",
        "live_refreshed_just": "odświeżono przed chwilą",
        "live_status_no_match": "Brak meczów na żywo",
        "live_status_next_in": "Najbliższy mecz za {time}",
        "live_status_finished": "Mecz zakończony",
